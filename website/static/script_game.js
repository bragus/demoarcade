...
score = {
    ...
    start : function(){
        ...
        this.x_nick = canvas_largura - (320 * escala_jogo);
        this.y_nick = canvas_altura - (50 * escala_jogo);
    ...
    desenhar : function(){
        ...
        let font = tamanho.toString().concat("px 'Press Start 2P'");
        ctx.font = font;
        ctx.fillText(this.valorScore, this.x, this.y);

        tamanho = Math.floor(30 * escala_jogo);
        font = tamanho.toString().concat("px 'Press Start 2P'");
        ctx.font = font;
        ctx.fillText(nickname, this.x_nick, this.y_nick);
...
function main(){ //Inicializa o jogo    
    ...
    recorde = document.getElementById("corpo_pagina").getAttribute("pontuacao");
